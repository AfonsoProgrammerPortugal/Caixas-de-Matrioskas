...
public class ArrayStack<E> implements Cloneable, Stack<E> {
    ...
    /**
     * Index of the top element of the stack in the array. -1 for an empty stack.
     */
    private int top;
     ...
     * (non-Javadoc)
     *
     * @see datatypes.stack.Stack#isFull()
     */
     ...
     * (non-Javadoc)
     *
     * @see datatypes.stack.Stack#size()
     */
    public int size() {
	    return top + 1;
    }
    ...
    /**
     * The textual representation of the Stack, in the form "a:b:c:[]", where "c" is
    ...
    /**
     * A faithful copy of this stack. Clones the backbone (the array) of the stack,
    ...
    public boolean equals(Object other) {
	    return this == other || other instanceof ArrayStack && equalStacks((ArrayStack<E>) other);
    }
    ...
    /**
     * Uses {@code clone()} to create a copy of this stack.
     */
    @Override
    public ArrayStack<E> copy() {
        @SuppressWarnings("unchecked")
        ArrayStack<E> result = (ArrayStack<E>) clone();
        return result;
    }
}